 ...
 */
function collides(l1, l2, allowOverlap) {
 ...
 */
function compact(layout, verticalCompact, allowOverlap) {
 ...
 */
function compactItem(compareWith, l, verticalCompact, allowOverlap) {
  if (verticalCompact) {
 ...
 */
function correctBounds(layout, bounds, allowOverlap) {
...
function getAllCollisions(layout, layoutItem, allowOverlap) {
  return allowOverlap ? [] : layout.filter(function (l) {
    return collides(l, layoutItem, allowOverlap);
  });
}
 ...
 */
function moveElement(layout, l, x, y, isUserAction, allowOverlap) {
  ...
  var collisions = getAllCollisions(sorted, l, allowOverlap);
 ...
 *                                   by the user.
 */
function moveElementAwayFromCollision(layout, collidesWith, itemToMove, isUserAction, allowOverlap) {
 ...
 */
function synchronizeLayoutWithChildren(initialLayout, children, cols, verticalCompact, allowOverlap) {
